  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && !value) {
        showError(field, isRTL ? 'هذا الحقل مطلوب' : 'This field is required');
        return false;
      }
      ...
      if (field.type === 'email' && value) {
        ...
        if (!emailRegex.test(value)) {
          showError(field, isRTL ? 'يرجى إدخال بريد إلكتروني صالح' : 'Please enter a valid email');
          return false;
        }
      }
      ...
      if (field.type === 'tel' && value) {
        ...
        if (!phoneRegex.test(value)) {
          showError(field, isRTL ? 'يرجى إدخال رقم هاتف صالح' : 'Please enter a valid phone number');
          return false;
        }
      }
      
      if (field.minLength && value.length < field.minLength) {
        showError(field, (isRTL ? 'الحد الأدنى ' + field.minLength + ' أحرف' : 'Minimum ' + field.minLength + ' characters'));
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '28f7aa7a-a4ea-42b8-a361-bdff70c7855e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '28f7aa7a-a4ea-42b8-a361-bdff70c7855e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '28f7aa7a-a4ea-42b8-a361-bdff70c7855e';
